    ...
    (start [this]
      ...
      (defn criar-tarefa [request]
        (let [uuid (java.util.UUID/randomUUID)
          ...
          {:status 200 :body {:mensagem "Tarefa registrada com sucesso!" :tarefa tarefa}}))

      (defn funcao-hello [request]
        {:status 200 :body (str "Olá, seja bem vindo!!! " (get-in request [:query-params :name] "Everybody"))})
      ...
      (defn atualizar-tarefa [request]
        (let [tarefa-id (get-in request [:path-params :id])
          ...
          {:status 200 :body {:mensagem "Tarefa atualizada com sucesso!" :tarefa tarefa}}))
      ...
      (def routes (route/expand-routes
                    #{["/hello" :get funcao-hello :route-name :hello-world]
                      ...
                      ["/tarefa/:id" :patch atualizar-tarefa :route-name :atualiza-tarefa]}))
